              ...
              'background-color:' +  item.color + '35;' +
               'border-left-color: '+item.color+ ';' +
                'color:' + item.color"
                    ...
                    <span v-if="item.course_id" class="tooltiptext">
...
.in_one_line:nth-child(1) {
  height: 8%;
}

.in_one_line:nth-child(2) {
  height: 92%;
}
...
tbody > td:nth-child(8) .tooltiptext {
